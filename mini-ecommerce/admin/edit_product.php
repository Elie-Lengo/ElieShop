...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!csrf_verify()) {
        ...
        // On garde les valeurs saisies affichées même en cas d'erreur
...
<head>
    ...
    <title>Modifier produit | ElieShop Admin</title>
...
<body>
    ...
    <main class="container">
        <div class="form-card">
            <h1 class="page-title" style="font-size:1.6rem;">Modifier un produit</h1>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" id="price" name="price" step="0.01" min="0.01"
